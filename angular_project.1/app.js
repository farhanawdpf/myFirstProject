...
var base_url="http://localhost/angular_project.1/";
...
app.config(function($routeProvider) {
    $routeProvider.when("/", {
		...
		title:"Plants",
        templateUrl : "pages/plant.php",
        controller : "plantCtrl"
    }).when("/cake", {
		title:"Cakes",
        templateUrl : "pages/cake.php",
        controller : "cakeCtrl"
    }).when("/cart", {
		title:"Cart",
...
//----------plant----------//
app.controller("plantCtrl", function ($rootScope,$scope,$http,$localStorage) {  
...
});//end plant controller

//-------------cake----------------//
app.controller("cakeCtrl", function ($rootScope,$scope,$http,$localStorage) { 
